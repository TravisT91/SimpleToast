...
sealed class SecondaryUserListItem(val viewType: Int) {
    class ActiveSecondaryUserType(val name: CharSequence, val cardStatus: ProductCardModelCardStatus) : SecondaryUserListItem(SecondaryUserListRecyclerViewAdapter.VIEW_TYPE_USER)
