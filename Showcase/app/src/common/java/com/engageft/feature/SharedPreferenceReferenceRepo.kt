...
object SharedPreferenceReferenceRepo {
    ...
    val sharedPreferenceRefences: SharedPreferences = ShowcaseApplication.sInstance.getSharedPreferences(SHARED_PREFERENCE_REFERENCE_KEY, Context.MODE_PRIVATE)
    ...
    fun clearAllSharedPreferences() {
        ...
        for (key: String in keys) {
            val sharedPreferences = ShowcaseApplication.sInstance.getSharedPreferences(key, Context.MODE_PRIVATE)
